...
#define ERR_UNKNOWN_FAILED				0x01
#define ERR_AUTH_FAILED					0x02
#define ERR_AUTH_INVALID_VERSION		0x03
#define ERR_AUTH_TIME_LIMIT				0x04
#define ERR_AUTH_MAC_FAILED				0x05
#define ERR_AUTH_USER_OUT_OF_DATE		0x06
#define ERR_FAILED_AFTER_SUCCESS		0xFF
